...
\newcommand{\demoframe}[2]{\only<presentation>{
  \begin{frame}\begin{center}{\Huge #1}\\\bigskip{\Large
        #2}\end{center}\end{frame}}}
...
\begin{subsecframe}{HoTT or OTT?}
  ...
  \item 
    ...
    \item \alert{\emph{Propositionally}}: \mode<article>{
      ...
      \mode<presentation>{Functional extensionality, \emph{not} iso. types are equal}
    \end{itemize}
  \end{itemize}
